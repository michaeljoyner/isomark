{!! Form::open(['url' => 'booking', 'class' => 'form-horizontal isomark-form']) !!}
...
<div class="form-group">
    ...
    <div class="col-md-9">
        <input class="form-control" type="text" name="course_names" @if(isset($course_names)) value="{{ $course_names }}" @else value="{{ Input::old('course_names') }}" @endif/>
    </div>
</div>
<div class="form-group">
